...
use sp_runtime::traits::{self, BlakeTwo256, Block as BlockT, SaturatedConversion, ConvertInto, OpaqueKeys, NumberFor, AccountIdLookup};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("xxdot"),
	impl_name: create_runtime_str!("praxxis-xxdot"),
	authoring_version: 1,
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		TransactionPayment: pallet_transaction_payment::{Pallet, Storage} = 25,
		...
		Historical: pallet_session_historical::{Pallet} = 26,
		...
		// Tips
		Tips: pallet_tips::{Pallet, Call, Storage, Event<T>} = 28,
	}
);
